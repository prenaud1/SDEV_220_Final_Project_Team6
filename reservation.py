...
def on_submit():
    ...
    message = f'Thank you! A reservation has beel placed for: {name}. \n \n\
            You reservation will be for a party of {size} seated at the {seat} starting at {time}. \n'
    if number:
            message += f"We will text the phone number {number} when your table is ready. \n"
    if address:
